  ...
  const exportBulkCandidatesTxt = React.useCallback(async (safe: boolean, requestedFileName: string) => {
    ...
    try {
      ...
      if (Platform.OS === "android" && FileSystem.StorageAccessFramework) {
         ...
         */
        if (perm.granted && /com\.android\.providers\.downloads\.documents\/tree\/downloads$/i.test(String(perm.directoryUri||""))) {
          ...
          Alert.alert(
            "İndirilenler klasörüne yazılamıyor",
            "Android, İndirilenler klasörünün KÖKÜNE dosya oluşturulmasına izin vermiyor.\n\n" +
            "Şunlardan birini yapın:\n" +
            "• İndirilenler içinde bir alt klasör oluşturun (ör. Downloads/KIZILKAN) ve onu seçin\n" +
            "• Belgeler (Documents) gibi başka bir klasör seçin\n" +
            "• Ya da \"Paylaş / Farklı Kaydet\" ile kaydedin",
            [
