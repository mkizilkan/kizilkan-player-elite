...
ok(pkg.version==='16.14.3'&&app.expo.version==='16.14.3'&&app.expo.android.versionCode===161403,'v16.14.3 metadata');
ok(app.expo.ios.buildNumber==='16.14.3'&&String(app.expo.extra?.kizilkanReleaseLabel||'').includes('16.14.3'),'iOS/release label synchronized');
