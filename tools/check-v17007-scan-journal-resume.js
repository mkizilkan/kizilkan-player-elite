...
r((()=>{const p=String(pkg.version||'').split('.').map(Number);return (p[0]||0)>17||((p[0]||0)===17&&((p[1]||0)>0||((p[1]||0)===0&&(p[2]||0)>=7)))})()&&app.expo.version===pkg.version&&Number(app.expo.android.versionCode)>=170007,'v17.0.7+ sürüm zinciri');
