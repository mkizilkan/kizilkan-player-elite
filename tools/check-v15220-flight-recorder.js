...
{ const d=read('frontend/src/utils/diagnostics.ts'); const m=d.match(/KIZILKAN_FLIGHT_RECORDER_V(\d+)/); if(!m || Number(m[1])<3){ console.log('HATA — Flight Recorder V3+ export'); bad++; } }
