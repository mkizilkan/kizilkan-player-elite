...
ok(semverAtLeast(pkg.version,17,1,0)&&semverAtLeast(app.expo.version,17,1,0)&&app.expo.android.versionCode>=170100&&/^GPT ELITE v17\.(?:1\.\d+|[2-9][0-9]*\.\d+) RC1$/.test(app.expo.extra?.kizilkanReleaseLabel||''),'v17.1.0+ sürüm zinciri');
