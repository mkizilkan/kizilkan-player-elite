...
ok(semverAtLeast(pkg.version,17,1,0)&&semverAtLeast(app.expo.version,17,1,0)&&app.expo.android.versionCode>=170100&&(String(app.expo.extra?.kizilkanReleaseLabel||'')===`GPT ELITE v${pkg.version} RC1`),'v17.1.0+ sürüm zinciri');
