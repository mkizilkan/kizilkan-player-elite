...
ok(pkg.version==='16.14.2','version 16.14.2');
ok(app.expo.version==='16.14.2' && app.expo.android.versionCode===161402,'app version/versionCode 16.14.2 / 161402');
ok(app.expo.ios.buildNumber==='16.14.2','iOS buildNumber synchronized');
ok(String(app.expo.extra?.kizilkanReleaseLabel||'').includes('16.14.2'),'release label synchronized');
...
console.log('TEMIZ — v16.14.2 integrated source hard-gate');
