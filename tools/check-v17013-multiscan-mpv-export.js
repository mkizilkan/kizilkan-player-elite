...
ok(semverAtLeast(pkg.version,'17.0.13')&&semverAtLeast(app.expo.version,'17.0.13')&&semverAtLeast(app.expo.ios.buildNumber,'17.0.13')&&app.expo.android.versionCode>=170013&&(String(app.expo.extra?.kizilkanReleaseLabel||'')===`GPT ELITE v${pkg.version} RC1`),'v17.0.13+ sürüm zinciri');
