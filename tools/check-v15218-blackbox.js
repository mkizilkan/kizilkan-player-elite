...
const checks=[
 ...
 ['blackbox-v2+', diagnostics.includes('KIZILKAN_BLACK_BOX_V2') || diagnostics.includes('KIZILKAN_FLIGHT_RECORDER_V3') || diagnostics.includes('KIZILKAN_FLIGHT_RECORDER_V4') || diagnostics.includes('KIZILKAN_FLIGHT_RECORDER_V5') || diagnostics.includes('KIZILKAN_FLIGHT_RECORDER_V6')],
