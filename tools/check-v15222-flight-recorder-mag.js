...
{const d=read('frontend/src/utils/diagnostics.ts'),m=d.match(/KIZILKAN_FLIGHT_RECORDER_V(\d+)/);if(!m||Number(m[1])<4){console.log('HATA — Flight Recorder V4+ export yok');bad++;}}
