...
r(gate7.includes('170007')&&gate7.includes('pkg.version'),'v17.0.7 koruma gate forward-compatible');
...
if(f){console.error(`❌ ${f} v17.0.8+ gate hatası`);process.exit(1)} console.log('PASS: v17.0.8+ conservative checkpoint / resume-progress contract TEMİZ');
