...
ok((M>16||(M===16&&(m>14||(m===14&&p>=8))))&&app.expo.version===pkg.version&&app.expo.android.versionCode===expected,'v16.14.8+ metadata synchronized');
ok(app.expo.ios.buildNumber===pkg.version&&String(app.expo.extra?.kizilkanReleaseLabel||'').includes(pkg.version),'release metadata synchronized');
