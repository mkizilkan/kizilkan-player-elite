...
const checks=[
 ...
 ['MPV TextureView render target',/TextureView\.SurfaceTextureListener/.test(mpv)&&/Surface\(surfaceTexture\)/.test(mpv)&&(/attachSurface\(renderSurface\)/.test(mpv)||(/val surface = Surface\(surfaceTexture\)/.test(mpv)&&/attachSurface\(surface\)/.test(mpv)))],
