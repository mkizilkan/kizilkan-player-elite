...
ok(semverAtLeast(pkg.version,17,0,12)&&semverAtLeast(app.expo.version,17,0,12)&&semverAtLeast(app.expo.ios.buildNumber,17,0,12)&&Number(app.expo.android.versionCode)>=170012&&(String(app.expo.extra?.kizilkanReleaseLabel||'')===`GPT ELITE v${pkg.version} RC1`),'v17.0.12+ sürüm zinciri');
